...
### 🏗️ Core Infrastructure ([`k-nuth/kth`](https://github.com/k-nuth/kth))
...
- **Version history & repo transition**: [`docs/VERSION_HISTORY.md`](https://github.com/k-nuth/kth/blob/master/docs/VERSION_HISTORY.md)
...
| Component | Latest |
|---|---|
| Knuth ([`k-nuth/kth`](https://github.com/k-nuth/kth)) | ![](https://img.shields.io/github/v/release/k-nuth/kth?display_name=tag&style=for-the-badge&color=3b009b&logo=bitcoincash) |
...
For the story behind the version numbers (and why Node appears to "skip" 0.59 → 0.67), see [`docs/VERSION_HISTORY.md`](https://github.com/k-nuth/kth/blob/master/docs/VERSION_HISTORY.md).
...
Knuth is released under the MIT license. See [`COPYING`](https://github.com/k-nuth/kth/blob/master/COPYING) or [opensource.org/licenses/MIT](https://opensource.org/licenses/MIT).

## Contributing

See [`docs/BRANCH_CONVENTIONS.md`](https://github.com/k-nuth/kth/blob/master/docs/BRANCH_CONVENTIONS.md) in the main repo for branch-naming conventions and the rest of the contribution flow.
